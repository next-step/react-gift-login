...
const SectionWrapper = styled.section<{ spacing?: 'sm' | 'md' | 'lg' }>`
  margin-bottom: ${props => {
    switch (props.spacing) {
      case 'sm': return props.theme.spacing.spacing6;
      case 'md': return props.theme.spacing.spacing8;
      case 'lg': return props.theme.spacing.spacing12;
      default: return props.theme.spacing.spacing8;
    }
  }};
`;
